...
namespace AMWUtil.Exception
{
...

    {
        ...
        public AMWException(
            ...
            : base(
                string.Format(code + ":" 
                    + (Language == ENLanguage.EN ? AMWUtil.Common.AttributeUtil.GetAttributeOfType<AMWExceptionDescription>(code).EN :
                    Language == ENLanguage.CN ? AMWUtil.Common.AttributeUtil.GetAttributeOfType<AMWExceptionDescription>(code).CN :
                        AMWUtil.Common.AttributeUtil.GetAttributeOfType<AMWExceptionDescription>(code).TH)
