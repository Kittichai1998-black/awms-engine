    ...
    return (
        <div>
            {type === 'link' ?
                ...
                type === "dialog" ?
                    <div>
                        <IconButton size="small" aria-label="info" onClick={handleClickOpenDialog} style={{ marginLeft: '3px' }}>
                    ...
                    :
                    <IconButton size="small" aria-label="info" onClick={PageDetail} style={{ marginLeft: '3px' }}>
                        <SaveIcon fontSize="small" style={{ color: '#1a237e' }} />
                    </IconButton>
            }
