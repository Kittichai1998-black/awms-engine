...
import { ButtonGroup, Button, Card, CardBody, CardGroup, Col, Container, Input, InputGroup, InputGroupAddon, InputGroupText, Row } from 'reactstrap';
  ...
  render() {
    return (
      <div>
        ...
        <Row className="justify-content-center" style={{ marginTop: "5px", marginBottom: "5px" }}>
              <Link to="/Queue?IOType=IN" ><Button style={{ marginRight: "5px", fontWeight: '500', color: '#fff', width: '10.75em' }} color="info">Receiving Progress</Button></Link>
              <Link to="/Queue?IOType=OUT" ><Button style={{ marginRight: "5px", fontWeight: '500', color: '#fff', width: '10.75em' }} color="success">Issuing Progress</Button></Link>
              <Link to="/Dashboard"><Button style={{ fontWeight: '500', color: '#fff', width: '10.75em' }} color="warning">Picking Progress</Button></Link>
            </Row>
        </div>
