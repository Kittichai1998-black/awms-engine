        ...
        <div>
          ...
          <div style={{display:this.state.openGuild, fontSize:"18px", color:"red"}}>Guide for Picking : {this.state.guideLoc}</div>
            ...
            <TabContent activeTab={this.state.activeTab}>
              ...
              <TabPane tabId="2">
                <label>Conso : </label><Input type="text" placeholder="Input Base" value={this.state.consoStatus} onChange={e => this.setState({consoBarcode:e.target.value})} style={{display:"inline-block", width:"200px"}}/>
                <br/>
                <label>Picking : </label>
