...
class JobSchedule extends Component{
  ...
  render(){
    const cols = [
      ...
      {accessor: 'CronExpressions', Header: 'CronExpressions', editable:true,Filter:"text"},
    ...
    return(
      ...
      */}
        <TableGen column={cols} data={this.state.select} dropdownfilter={this.state.statuslist} exportbtn={true} expFilename={"JobSchedule"}
