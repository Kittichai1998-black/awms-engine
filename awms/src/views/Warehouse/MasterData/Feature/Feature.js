...
class Feature extends Component {
  ...
  async componentWillMount() {
    ...
    CheckWebPermission("Feature", dataGetPer, this.props.history);
    ...
    return (
      ...
      */}
        <TableGen column={cols} data={this.state.select} dropdownfilter={this.state.statuslist}
          filterable={true} accept={view} btn={btnfunc} expFilename={"Feature"}
          uneditcolumn={this.uneditcolumn} exportfilebtn={view} addExportbtn={view}
          table="ams_Feature" />
      </div>
    )
  }
