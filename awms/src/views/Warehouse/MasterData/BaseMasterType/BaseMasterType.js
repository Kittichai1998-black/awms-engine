...
class BaseMasterType extends Component{
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      t:"BaseMasterType",
      q:"[{ 'f': 'Status', c:'<', 'v': 2}]",
      f:"ID,Code,Name,Description,UnitType_ID,GroupType,SizeLevel,Status,Created,Modified",
      g:"",
      s:"[{'f':'ID','od':'asc'}]",
      sk:"",
      l:100,
  ...
  render(){
    const cols = [
      ...
      {accessor: 'UnitType_ID', Header: 'UnitType ID', editable:true,Filter:"text"},
      {accessor: 'GroupType', Header: 'GroupType', editable:true,Filter:"text"},
      {accessor: 'SizeLevel', Header: 'SizeLevel', editable:true,Filter:"text"},
