...
class Area extends Component{
    ...
    render(){
        const cols = [
          ...
          {field: 'Warehouse_ID', header: 'Warehouse ID', sortable:false},
          {field: 'AreaMasterType_ID', header: 'AreaMasterType_ID', sortable:false},
        ...
        return(
          ...
          */}
          ...
          statuslist = {this.state.statuslist} table="ams_Area"/>
          <Card>
            <CardBody style={{textAlign:'right'}}>
              <Button onClick={this.onHandleClickLoad} color="danger"className="mr-sm-1">Load ข้อมูล</Button>
            </CardBody>
          </Card>
          </div>
        )
