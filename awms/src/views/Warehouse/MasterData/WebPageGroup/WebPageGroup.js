...
class WebPageGroup extends Component {
  ...
  async componentWillMount() {
    ...
    CheckWebPermission("WebPageGroup", dataGetPer, this.props.history);
  ...
  render() {
    ...
    return (
      ...
      */}
        <TableGen column={cols} data={this.state.select} dropdownfilter={this.state.statuslist} expFilename={"WebPageGroup"}
