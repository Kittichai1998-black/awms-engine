 ...
 /*  createBarcodeBtn(data){
  ...
  render(){
    const cols = [
      ...
      {accessor: 'WidthM', Header: 'Width', editable:true,Filter:"text", datatype:"int",},
      {accessor: 'LengthM', Header: 'Length', editable:true,Filter:"text", datatype:"int",},
      {accessor: 'HeightM', Header: 'Height', editable:true,Filter:"text", datatype:"int",},
