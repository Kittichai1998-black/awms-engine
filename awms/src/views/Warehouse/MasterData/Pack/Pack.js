...
class Pack extends Component{
    ...
    render(){
        const cols = [
          ...
          {accessor: 'WeightKG', Header: 'Gross Weight (Kg.)', editable:false,Filter:"text", datatype: "int", className: "center"},
          ...
          {accessor: 'ItemQty', Header: 'Base Qty', editable:false,Filter:"text",datatype:"int", className: "center"},
