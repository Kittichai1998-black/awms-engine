...
class Pack extends Component {
    ...
    render() {
        ...
        const cols = [
            ...
            { accessor: 'UnitTypeCode', Header: 'Unit', updateable: false, Filter: "text", Type: "autocomplete", minWidth: 80, className: "left" },
            { accessor: 'WeightKG', Header: 'Weight (Kg.)/Unit', editable: false, Filter: "text", datatype: "int", className: "right", minWidth: 80 },
