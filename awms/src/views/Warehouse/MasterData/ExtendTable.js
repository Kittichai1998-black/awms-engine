        ...
        <nav>
          <ul className="pagination">
            <li className="page-item"><a className="page-link" style={this.state.currentPage === 1 ? notPageactive : pageactive}
              ...
              Previous</a></li>
            {/* แสดงแบบ page 1 of จำนวนหน้าทั้งหมด */}
            ...
            <p style={{ margin: 'auto', minWidth: "60px", paddingRight: "10px", paddingLeft: "10px", verticalAlign: "middle" }}>Page : {this.state.currentPage}</p>
