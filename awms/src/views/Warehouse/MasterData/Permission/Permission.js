...
class Permission extends Component {
  ...
  async componentWillMount() {
    ...
    CheckWebPermission("Permission", dataGetPer, this.props.history);
    ...
    return (
      <div>
        {/*
            ...
            */}
        <TableGen column={cols} data={this.state.select} dropdownfilter={this.state.statuslist} expFilename={"Permission"}
          filterable={true} autocomplete={this.state.autocomplete} accept={view} btn={btnfunc} exportfilebtn={view} addExportbtn={view}
