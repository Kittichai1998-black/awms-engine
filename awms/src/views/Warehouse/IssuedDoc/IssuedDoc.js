...
class IssuedDoc extends Component{
  constructor(props) {
    ...
    this.state = {
      ...
      f:"ID,Code,SouBranchName,SouWarName,SouAreaName,DesCusName,ForCustomer,Batch,Lot,ActionTime,DocumentDate,EventStatus,RefID,CreateBy,ModifyBy",
      g:"",
      s:"[{'f':'ID','od':'desc'}]",
      sk:0,
      l:20,
  ...
  render(){
    const cols = [
      ...
      {accessor: 'SouWarName', Header: 'Warehouse', editable:false, Filter:"text",},
      {accessor: 'SouAreaName', Header: 'Area', editable:false, Filter:"text",},
      {accessor: 'DesCusName', Header: 'Customer', editable:false, Filter:"text",},
