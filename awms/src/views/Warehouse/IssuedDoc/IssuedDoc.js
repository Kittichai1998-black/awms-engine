...
class IssuedDoc extends Component{
  constructor(props) {
    ...
    this.state = {
      ...
      f:"ID,Code,SouBranchName,SouWarehouseName,SouAreaName,DesCustomerName,ForCustomer,Batch,Lot,ActionTime,DocumentDate,EventStatus,RefID,CreateBy,ModifyBy",
      g:"",
      s:"[{'f':'ID','od':'desc'}]",
      sk:0,
      l:20,
