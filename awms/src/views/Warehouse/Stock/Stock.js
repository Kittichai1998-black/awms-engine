...
import { GetPermission, CheckWebPermission } from '../../ComponentCore/Permission';
...
class Stock extends Component {
  ...
  async componentWillMount() {
    document.title = "Stock Correction Manage : AWMS";
    //permission
    // 36	WarehouseSCD_view
    // 37	WarehouseSCD_create&modify
    this.setState({ showbutton: "none" })
    let dataGetPer = await GetPermission()
    CheckWebPermission("STCM", dataGetPer, this.props.history);
  }
