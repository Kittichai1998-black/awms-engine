    ...
    useEffect(()=> {
        ...
        if(dataWarehouse!== "" && dataMovementType!==""){
                ...
                var headerCreates = [
                    ...
                    [{ label: "Movement Type", type: "labeltext", key: "movementTypeID",texts:dataMovementType, valueTexts: "1011" }, { label: "Action Time", type: "dateTime", key: "actionTime" },],
                    [{ label: "Source Warehouse", type: "labeltext", key: "souWarehouseID", texts: dataWarehouse, valueTexts: "1" },{ label: "Destination Warehouse", key: "desWarehouseID", type: "dropdown", pair: "ID", idddl: "desWarehouseID", queryApi: WarehouseQuery2, fieldLabel: ["Code", "Name"]}],
...
export default CreateDocGITAPWM;