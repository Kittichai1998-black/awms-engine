                                            ...
                                            WorkQueueLists3.ForEach(wq =>
                                            {
                                                ...
                                                if (docs.Ref1 == "R01" || docs.Ref1 == "R02" || docs.Ref1 == "R06")
                                                {
                                                    ...
                                                    IN_REQ inReq = new IN_REQ() {
                                                        ZMODE = docs.Ref1,
                                                        LGNUM = "W01",
                                                        LENUM = docs.Ref1 == "R01" ? docItem.Code : null,
                                                        RSNUM = docs.Ref1 == "R02" ? long.Parse(docItem.RefID) : null as long?,
                                                        MATNR = docs.Ref1 == "R02" || docs.Ref1 == "R06" ? docItem.Code : null,
                                                        ...
                                                        LGTYP = optionsItem[OptionVOConst.OPT_LGTYP],
                                                        LGBER = optionsItem[OptionVOConst.OPT_LGBER],
                                                        LGPLA = optionsItem[OptionVOConst.OPT_LGPLA],
                                                        BWLVS = docs.Ref2,
                                                ...
                                                else if (docs.Ref1 == "R05")
                                                {
                                                    ...
                                                    IN_REQ inReq = new IN_REQ() {
                                                        ...
                                                        BESTQ_QI = optionsItem[OptionVOConst.OPT_BESTQ_QI],
                                                        BESTQ_BLK = optionsItem[OptionVOConst.OPT_BESTQ_BLK],
                                                        POSNR = long.Parse(optionsItem[OptionVOConst.OPT_POSNR]),
                                                        VBELN_VL = optionsItem[OptionVOConst.OPT_VBELN_VL],
