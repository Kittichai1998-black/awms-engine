...
namespace AWMSEngine.ADO.WMSDB
{
    public class DistoADO : BaseMSSQLAccess<DistoADO>
    {
        ...
        {
            List<amt_DocumentItemStorageObject> distos = ADO.WMSDB.DataADO.GetInstant().SelectBy<amt_DocumentItemStorageObject>(
        ...
        {
            var distos = ADO.WMSDB.DataADO.GetInstant().SelectBy<amt_DocumentItemStorageObject>(
                new SQLConditionCriteria[]
                {
