...
namespace AWMSEngine.APIService.WM
{
    ...
    {
        public ScanPickingAndConsoAPI(ControllerBase controllerAPI,int apiServiceID = 0, bool isAuthenAuthorize = true) : base(controllerAPI, apiServiceID, isAuthenAuthorize)
        { 
        }
