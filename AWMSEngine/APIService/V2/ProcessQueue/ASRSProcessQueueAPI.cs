...
namespace AWMSEngine.APIService.V2.ProcessQueue
{
    ...
    {
        public ASRSProcessQueueAPI(ControllerBase controllerAPI, int apiServiceID = 0, bool isAuthenAuthorize = true) : base(controllerAPI, apiServiceID, isAuthenAuthorize)
        {
        }
