...
namespace AWMSEngine.APIService.V2.Business
{
    ...
    {
        public SelectPickingManualAPI(ControllerBase controllerAPI,int apiServiceID = 0, bool isAuthenAuthorize = true) : base(controllerAPI, apiServiceID, isAuthenAuthorize)
        {
        }
