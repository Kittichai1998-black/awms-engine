...
namespace AWMSEngine.APIService.V2.Business
{
    ...
    { 
        public GeneratePalletAPI(AWMSEngine.Controllers.V2.BaseController controllerAPI,int apiServiceID = 0, bool isAuthenAuthorize = true) : base(controllerAPI, apiServiceID, isAuthenAuthorize)
        {
        }
