...
namespace AWMSEngine.APIService.V2.Report
{
    ...
    {
        public PrintTagQRandBarcodeAPI(ControllerBase controllerAPI, int apiServiceID = 0, bool isAuthenAuthorize = true) : base(controllerAPI, apiServiceID, isAuthenAuthorize)
        {
        }
