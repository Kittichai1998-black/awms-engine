...
namespace AWMSEngine.APIService.V2.General
{
    public class RemoveFileImageAPI : BaseAPIService
    {
        ...
        public RemoveFileImageAPI(ControllerBase controllerAPI, int apiServiceID = 0, bool isAuthenAuthorize = true) : base(controllerAPI, apiServiceID, isAuthenAuthorize)
        {
        }
