...
{
    public class GetSTOCouting : BaseEngine<GetSTOCouting.TReq, GetSTOCouting.TRes>
    {
        ...
        protected override TRes ExecuteEngine(TReq reqVO)
        {
            ...
            if (reqVO.bstoCode == null)
            {
                ...
                {
                    throw new AMWException(Logger, AMWExceptionCode.V1001, "กรุณาระบุรหัสพาเลทที่ต้องการตรวจนับ");
                }
            }
            else
            {
