...
namespace AWMSEngine.Engine.V2.Business.Shipment
{
    public class CreateSODocument : BaseEngine<CreateSODocument.TReq, amt_Document>
    {
        public class TReq
        {
            ...
            public List<IssueItem> shipmentItems;
        ...
        protected override amt_Document ExecuteEngine(TReq reqVO)
        {
            ...
            var doc = new CreateDocument().Execute(this.Logger, this.BuVO,
                new CreateDocument.TReq()
                {
                    ...
                    docTypeId = DocumentTypeID.SHIPMENT_ORDER,
                    eventStatus = reqVO.eventStatus,
                    documentProcessTypeID = reqVO.movementTypeID,
                    remark = reqVO.remark,

                    Items = reqVO.shipmentItems.Select(
