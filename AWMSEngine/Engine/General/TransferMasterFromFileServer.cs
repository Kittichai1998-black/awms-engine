            ...
            foreach (string fn in fileNames)
            {
                            ...
                            fieldNames.ToList().ForEach(x => 
                            {
                                if (!string.IsNullOrWhiteSpace(x))
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        var objStatic = ADO.StaticValue.StaticValueManager.GetInstant();
                ...
                finally
                {
                    try
                    {
                        ...
                        using (StreamWriter swRes = new StreamWriter(apiResponsePath + refID + "." + DateTime.Now.ToString("ddMMyyhhmmss") + ".txt"))
                        {
