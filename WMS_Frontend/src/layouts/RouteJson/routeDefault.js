...
let routes = [
  ...
  { path: "/dashboard/inbound", name: "Inbound Progress", compoment: DashboardIO, exact: true },
  { path: "/dashboard/outbound", name: "Outbound Progress", compoment: DashboardIO, exact: true },
