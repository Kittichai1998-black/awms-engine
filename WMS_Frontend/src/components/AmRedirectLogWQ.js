  ...
  return (
    <div>
      {type === "link" ? (
        ...
        <div>
          <AmToolTip title={"Log WQ"} placement={"top"} >
            <IconButton
              size="small"
              aria-label="info"
...
export default AmRedirectLogWQ;
