...
const AmSetOjectSize = props => {
      ...
      { Header: "Name", accessor: "Name", width: 250 },
      {
        ...
        Cell: e => (
          <AmInput
            ...
            onChange={val => {
              onChangeEditorObjectSize(e.column.Header, e.original, val);
            }}
          />
        ),
        sortable: false
  ...
  async function onChangeEditorObjectSize(
    field,
    rowdata,
    value,
    type,
  ...
  async function UpdateRole(rowdata) {
    ...
    const Query3 = {
      ...
      f:
        "ID,OuterObjectSize_ID,InnerObjectSize_ID,Status,MinQuantity,MaxQuantity",
      g: "",
      s: "[{'f':'ID','od':'asc'}]",
      sk: 0,
      l: 100,
