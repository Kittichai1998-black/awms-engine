...
const BaseMasterLog = (props) => {
  ...
  const columns = [
    ...
    {
      Header: "BaseMasterType ID",
      accessor: "WidBaseMasterType_IDthM",
      width: 50,
    },
    {
      Header: "BaseMasterType Code",
      accessor: "BaseMasterType_Code",
      width: 50,
    },
    {
...
export default withStyles(styles)(BaseMasterLog);