...
const SKUConvertorLog = (props) => {
    ...
    const columns = [
        ...
        {
            Header: "PackMasterType ID",
            accessor: "PackMasterType_ID",
            width: 50,
        },
        {
            Header: "SKUMaster ID",
...
export default withStyles(styles)(SKUConvertorLog);