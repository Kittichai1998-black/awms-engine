...
const WaveEventLog = (props) => {
  ...
  const columns = [
    ...
    {
      Header: "Run Schedule Time",
      accessor: "RunScheduleTime",
      width: 150,
      type: "datetime",
      dateFormat: "DD/MM/YYYY HH:mm:ss",
      filterType: "datetime",
      ...
      customFilter: { field: "RunScheduleTime" },
    },
    {
      Header: "Priority",
      accessor: "Priority",
...
export default withStyles(styles)(WaveEventLog);