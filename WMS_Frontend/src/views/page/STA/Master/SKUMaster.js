...
const SKUMaster = props => {
  ...
  const iniCols = [
    ...
    {
      Header: window.project === "TAP" ? "Part NO." : "Reorder",
      accessor: "Code",
      fixed: "left",
      width: 120
    },
    {
      Header: window.project === "TAP" ? "Part Name" : "Brand",
      accessor: "Name",
      width: 250
    },
  ...
  const columns = [
    {
      field: "Code",
      type: "input",
      name: window.project === "TAP" ? "Part NO." : "Reorder",
      placeholder: "Code",
      required: true
    },
    {
      field: "Name",
      type: "input",
      name: window.project === "TAP" ? "Part Name" : "Brand",
      placeholder: "Name",
      required: true
    },
    {
