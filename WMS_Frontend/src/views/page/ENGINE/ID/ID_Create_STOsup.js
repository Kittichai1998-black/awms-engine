...
const ID_Create_STOwm = props => {
    ...
    useEffect(() => {
        ...
        if (dataMovementTypeCUS !== "") {
            var headerCreate = [
                ...
                [
                    { label: "Movement Type", type: "labeltext", key: "movementTypeID", texts: "STO_TRANSFER_SUP", valueTexts: "5013", codeTranslate: "Movement Type" },
    ...
    const MovementTypeQuery2 = {
        ...
        q: '[{ "f": "Status", "c":"<", "v": 2},{ "f": "ID", "c":"=", "v":5013}]',
        f: "ID,Code,Name",
        g: "",
        s: "[{'f':'ID','od':'asc'}]",
        sk: 0,
