...
const ID_Create_EMPwm = props => {
    ...
    useEffect(() => {
        ...
        if (dataMovementTypeCUS !== "") {
            var headerCreate = [
                ...
                [
                    { label: "Movement Type", type: "labeltext", key: "movementTypeID", texts: "EMP_TRANSFER_WM", valueTexts: "7011", codeTranslate: "Movement Type" },
    ...
    const MovementTypeQuery2 = {
        ...
        q: '[{ "f": "Status", "c":"<", "v": 2},{ "f": "ID", "c":"=", "v":7011}]',
        f: "ID,Code,Name",
        g: "",
        s: "[{'f':'ID','od':'asc'}]",
        sk: 0,
...
export default ID_Create_EMPwm;
