...
const ID_Create_WIPsup = props => {
    ...
    useEffect(() => {
        ...
        if (dataMovementTypeCUS !== "") {
            var headerCreate = [
                ...
                [
                    { label: "Movement Type", type: "labeltext", key: "movementTypeID", texts: "WIP_TRANSFER_SUP", valueTexts: "2013", codeTranslate: "Movement Type" },
    ...
    const MovementTypeQuery2 = {
        ...
        q: '[{ "f": "Status", "c":"<", "v": 2},{ "f": "ID", "c":"=", "v":2013}]',
        f: "ID,Code,Name",
        g: "",
        s: "[{'f':'ID','od':'asc'}]",
        sk: 0,
...
export default ID_Create_WIPsup;
