...
const ID_Create_STOwm = props => {
    ...
    useEffect(() => {
        ...
        if (dataMovementTypeCUS !== "") {
            var headerCreate = [
                ...
                [
                    { label: "Movement Type", type: "labeltext", key: "movementTypeID", texts: "STO_TRANSFER_CUS", valueTexts: "5012", codeTranslate: "Movement Type" },
    ...
    const MovementTypeQuery2 = {
        ...
        q: '[{ "f": "Status", "c":"<", "v": 2},{ "f": "ID", "c":"=", "v":5012}]',
        f: "ID,Code,Name",
        g: "",
        s: "[{'f':'ID','od':'asc'}]",
        sk: 0,
