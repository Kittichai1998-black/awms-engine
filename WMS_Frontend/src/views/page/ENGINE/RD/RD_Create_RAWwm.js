    ...
    useEffect(() => {
        ...
        if (dataMovementTypeCUS !== "") {
            var headerCreate = [
                ...
                [
                    { label: "Movement Type", type: "labeltext", key: "movementTypeID", texts: "RAW_TRANSFER_WM", valueTexts: "4011", codeTranslate: "Movement Type" },
...
export default RD_Create_RAWwm;
