    ...
    useEffect(() => {
        ...
        if (dataMovementTypeCUS !== "") {
            var headerCreate = [
                ...
                [
                    { label: "Movement Type", type: "labeltext", key: "movementTypeID", texts: " FG_TRANSFER_SUP", valueTexts: "1013", codeTranslate: "Movement Type" },
...
export default RD_Create_FGSUP;
