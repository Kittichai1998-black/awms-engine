...
const StockCard = (props) => {
    ...
    const GetBodyReports = () => {
        return <div style={{ display: "inline-block" }}>
            <FormInline><LabelH>Part NO. : </LabelH>
                <AmInput
                    id={"packCode"}
                    type="input"
                    style={{ width: "300px" }}
            ...
            <FormInline><LabelH>Movement : </LabelH>
                <AmDropdown
                    id={'movementType'}
                    fieldDataKey={"ID"}
            ...
            <FormInline><LabelH>Date From : </LabelH>
                <AmDate
                    id={"fromDate"}
                    TypeDate={"date"}
                    style={{ width: "300px" }}
            ...
            <FormInline><LabelH>Date To : </LabelH>
                <AmDate
                    id={"toDate"}
                    TypeDate={"date"}
                    style={{ width: "300px" }}
    ...
    const customBtnSelect = () => {
        return <AmButton styleType="confirm" onClick={onGetDocument} style={{ marginRight: "5px" }}>{'Select'}</AmButton>
    }
    const columns = [
