    ...
    useEffect(()=> {
        ...
        if(dataWarehouse!== ""  &&dataMovementTypeCUS!==""){
                ...
                var headerCreates = [
                    ...
                    [{ label: "Source Warehouse", type: "labeltext", key: "souWarehouseID", texts: dataWarehouse, valueTexts: "1" },{ label: "Destination Customer", key: "desCustomerID", type: "dropdown", pair: "ID", idddl: "desCustomerID", queryApi: CustomerQuery, fieldLabel: ["Code", "Name"]  }],
...
export default CreateDocGITAPCUS;