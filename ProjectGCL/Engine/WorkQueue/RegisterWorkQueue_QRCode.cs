...
{
    public class RegisterWorkQueue_QRCode : IProjectEngine<RegisterWorkQueue.TReq, WorkQueueCriteria>
    {
        protected override WorkQueueCriteria ExecuteEngine(AMWLogger logger, VOCriteria buVO, RegisterWorkQueue.TReq reqVO)
        {
