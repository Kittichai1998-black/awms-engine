...
namespace ADO.WCSStaticValue
{
    public partial class StaticValueManager
    {
        ...
        public List<acs_Warehouse> LoadWarehouse(VOCriteria buVO = null)
        {
            return this._Warehouses = ADO.WCSDB.DataADO.GetInstant().SelectBy<acs_Warehouse>("status", 1, buVO ?? new VOCriteria());
        }
